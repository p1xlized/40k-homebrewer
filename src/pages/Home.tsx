...
const testimonials = [
  {
    quote:
      "My crayon eating abomination was made thanks to this :3",
    name: "CrayonEater",
    designation: "Loyalist",
    src: "https://pbs.twimg.com/media/Gj2EawWW8AACufv.jpg:large",
  },
  {
    quote:
      "Easy to work, it helped me a lot in creation of my homebrew Chapter",
    name: "Eisenhorn",
    designation: "Eldar",
    src: "https://i0.wp.com/woehammer.com/wp-content/uploads/2022/01/5abc0d8cac539b3a58f63754e518c78b7348266530363298843.jpg?resize=474%2C504&ssl=1",
  },
  {
    quote:
      "This is the best tool I've ever used for creating my own homebrew",
    name: "Emily",
    designation: "Necrons",
    src: "https://i.etsystatic.com/48226847/r/il/e4d970/5746155140/il_fullxfull.5746155140_9h1o.jpg"
  },
  {
    quote:
      "Perfect as i expected from this guy",
    name: "James",
    designation: "Tau",
    src: "https://i.ebayimg.com/thumbs/images/g/LSUAAOSws~5koScc/s-l500.jpg"
  },
];
...
function LandingHero() {
  ...
  return (
    <>
      ...
      <div id="section2" className="min-h-screen w-screen">
        <div className="w-full">
          <FeaturesSectionWithBentoGrid />
        </div>
      </div>

      <section id="section3" className="w-screen max-h-screen h-screen overflow-hidden md:overflow-visible flex flex-col items-center justify-center relative">
        <h2 className="text-3xl sm:text-5xl md:text-7xl lg:text-6xl text-center w-full justify-center items-center flex-col flex whitespace-pre leading-tight font-calendas tracking-tight space-y-1 md:space-y-4">What our users think</h2>
