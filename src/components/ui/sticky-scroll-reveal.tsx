...
export const StickyScroll = ({
  ...
  // Remove the container ref so that we use the window scroll instead
  ...
  return (
    <motion.div
      ...
      className="h-screen flex justify-center relative space-x-10 rounded-md p-10"
    >
      ...
      <div
        ...
        className={cn(
          "hidden lg:block h-90 w-80 rounded-md bg-white sticky top-10 overflow-hidden",
          contentClassName
        )}
      >
